...
def mainfunc(tasknum):
    ...
    categories = ['baseline', 
                       'baseline',
                       'baseline',
                       'baseline','cameraJitter',
                       'cameraJitter',
                       'cameraJitter', 
                       'cameraJitter','badWeather', 
                       'badWeather',
                       'badWeather',
                       'badWeather','dynamicBackground',
                       'dynamicBackground',
                       'dynamicBackground',
                       'dynamicBackground',
                       'dynamicBackground',
    ...
    results_dir = os.path.join('ResSegNet', 'resultsALLCL' + str(num_frames))
    ...
    for t in range(Tasks):
        ...
        weights = np.load('weights_alldatasets_cl3_0.npy', allow_pickle=True, encoding="latin1").tolist()
        
        #weights = np.load('weights_cdnet_cl'+str(tasknum)+'_'+str(t)+'.npy', allow_pickle=True, encoding="latin1").tolist()
